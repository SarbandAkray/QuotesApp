...
app.on('ready', ()=>{
  ...
  let getversion = axios({
    method: 'get',
    url: 'https://apis-quote.herokuapp.com/getVersion',
    responseType: 'json',
...
function loadTheNotfication(){
  ...
  if (time == "OFF") {
    ...
    mint15 = setInterval(()=>{
      ...
      Q = notifications.q;
      A = notifications.a;
       let notifiaction15= new Notification({ title: notifications.a, body:notifications.q,icon:path.join(__dirname, 'logo.png') });
